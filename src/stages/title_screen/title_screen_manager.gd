...
const QUIT_GAME_CONFIRM = preload("res://src/utils/scenes/ui/quit_game_confirm.tscn")
const DEMO_BOSS_SELECTOR = preload("res://src/stages/demo_boss_selector/demo_boss_selector.tscn")
