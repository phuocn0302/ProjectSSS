...
const GODOT_BOSS = preload("res://src/entities/bosses/godot/godot_boss.tscn")
const GODOT_ENEMY = preload("res://src/entities/enemies/godot_enemy/godot_enemy.tscn")

const STAGE_RETRY = preload("res://src/utils/scenes/ui/stage_retry.tscn")
...
func _return_to_title() -> void:
	...
	get_tree().change_scene_to_file("res://src/stages/title_screen/title_screen.tscn")
