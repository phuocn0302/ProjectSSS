...
const PROJECTILE_HIT_PARTICLES = preload("res://particles/projectile_hit_particles.tscn")
const PROJECTILE_PARTICLES = preload("res://particles/projectile_particles.tscn")
